...
/**
 * Class for Topic Expertise Model with temporal information.
 * 
...
public class TTEMA extends LDABasedModel  {
	...
	public TTEMA(DataWoker trainUsers, DataWoker testUsers,int iternum) {
...
//		this.T= this.trainSet.timeCountMap.size();//number of time label
	...
	public void recommendUserForQuestionNOACT(QuestionPost p, int [] precision){
